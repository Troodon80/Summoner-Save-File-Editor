...
namespace SummonerSaveFileEditor.Services
{
    public static class SettingsManager
    {
        ...
        public static void SaveMdiWindowState(Form form)
        {
            if (form.WindowState == FormWindowState.Normal)
            {
                IniSettings.WriteInt(WINDOW_SECTION, "Left", form.Left);
            ...
            // Save MDI settings
            IniSettings.WriteBool(WINDOW_SECTION, "IsMdiContainer", form.IsMdiContainer);
        }
        ...
        public static void ApplyMdiWindowState(Form form)
        {
            // Apply standard window state first
            ApplyWindowState(form);

            // Apply MDI container status if this is an MDI form
            bool isMdiContainer = IniSettings.ReadBool(WINDOW_SECTION, "IsMdiContainer", false);
            if (isMdiContainer)
            {
