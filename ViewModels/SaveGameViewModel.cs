...
namespace SummonerSaveFileEditor.ViewModels
{
    public class SaveGameViewModel
    {
        ...
        public Dictionary<AreaScript, byte[]> ConversationMetadata { get; set; } = new Dictionary<AreaScript, byte[]>();
        public Dictionary<string, ConversationData> ConversationData { get; set; } = new Dictionary<string, ConversationData>();
        public byte[] RawConversationData { get; set; }
        public bool ConversationDataLoaded { get; set; } = false;
        ...
        public CharacterViewModel Summon { get; set; }
        public byte[] PostCreatureData { get; set; }
        public CameraViewModel Camera { get; set; }
        public List<Container> Containers { get; set; } = new List<Container>();
        public List<GoldPile> GoldPiles { get; set; } = new List<GoldPile>();
        public List<LevelItem> LevelItems { get; set; } = new List<LevelItem>();
        public ObservableCollection<QuestViewModel> Quests { get; set; } = new();
