...
namespace SummonerSaveFileEditor.ViewModels
{
    public class CharacterViewModel : INotifyPropertyChanged
    {
        ...
        public float PosX
        {
            get => _character.CharacterBlock.fPosX;
            set
            {
                if (_character.CharacterBlock.fPosX != value)
                {
                    _character.CharacterBlock.fPosX = value;
                    OnPropertyChanged();
                }
            }
        }
        ...
        public float PosY
        {
            get => _character.CharacterBlock.fPosY;
            set
            {
                if (_character.CharacterBlock.fPosY != value)
                {
                    _character.CharacterBlock.fPosY = value;
                    OnPropertyChanged();
                }
            }
        }
        ...
        public float PosZ
        {
            get => _character.CharacterBlock.fPosZ;
            set
            {
                if (_character.CharacterBlock.fPosZ != value)
                {
                    _character.CharacterBlock.fPosZ = value;
                    OnPropertyChanged();
                }
            }
        }
