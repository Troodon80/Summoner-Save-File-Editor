...
namespace SummonerSaveFileEditor.Models
{
    ...
    public class SummonerThumbnail
    {
        ...
        {
            int requiredLength = Constants.IMAGE_PIXEL_START + Constants.THUMBNAIL_WIDTH * Constants.THUMBNAIL_HEIGHT * 2; // Assuming 2 bytes per pixel for RGB565
            ...
            int src = Constants.IMAGE_PIXEL_START;
